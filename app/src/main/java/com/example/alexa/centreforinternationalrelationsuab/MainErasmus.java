...
public class MainErasmus extends AppCompatActivity
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<ShowNewPost, MainErasmus.ShowDataViewHolder> mFirebaseAdapter = new FirebaseRecyclerAdapter<ShowNewPost, MainErasmus.ShowDataViewHolder>(ShowNewPost.class, R.layout.show_news_item, MainErasmus.ShowDataViewHolder.class, myRef) {

            public void populateViewHolder(final MainErasmus.ShowDataViewHolder viewHolder, ShowNewPost model, final int position) {
