...
public class MainErasmusAcademic extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_erasmus_academic);
        ...
        mUserDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(getApplicationContext()).load(avatar).placeholder(R.drawable.logo).into(imageProfile);
            }
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<ShowNewPost, MainErasmusAcademic.ShowDataViewHolder> mFirebaseAdapter = new FirebaseRecyclerAdapter<ShowNewPost, MainErasmusAcademic.ShowDataViewHolder>(ShowNewPost.class, R.layout.show_news_item, MainErasmusAcademic.ShowDataViewHolder.class, myRef) {

            public void populateViewHolder(final MainErasmusAcademic.ShowDataViewHolder viewHolder, ShowNewPost model, final int position) {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_centre_description){
            Intent i = new Intent(getApplicationContext(), RelIntDescription.class);
            startActivity(i);
