...
public class OUsefulInfoVodafone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ouseful_info_vodafone);
        ...
        WebView webView = findViewById(R.id.webview_vodafone);

        //Specify the URL you want to display//
        webView.loadUrl("https://www.vodafone.ro/");
